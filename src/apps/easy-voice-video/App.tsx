...
const handleSelectWaveAudio = async () => {
  ...
  return (
    <div className="voice-video-appLight min-h-screen">
      <header className="voice-video-globalTitle">
        <div>EASY STUDIO</div>
        <h1>Easy Voice/Video</h1>
      </header>

      <div className="mx-auto max-w-7xl p-4 md:p-5 voice-video-contentWrap">

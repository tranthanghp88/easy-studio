// electron-env.d.ts
export {}; // Crucial for module augmentation in isolated/module environments
...
interface ElectronAPI {
  // App related
  isDesktop: boolean; // Bổ sung
  onUpdateStatus(callback: (p: any) => void): () => void; // Bổ sung
  ...
  selectVideoFiles?(): Promise<{ canceled: boolean; paths: string[] } | undefined>;
  ...
  /** Deprecated: kept optional only for stale Audio History/Folder Merge hooks. */
  ...
  readFileAsBase64(args: { filePath: string }): Promise<string>; // NEW

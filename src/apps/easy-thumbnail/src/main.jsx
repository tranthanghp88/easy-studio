    ...
    <div className="app">
      ...
      <header>
        ...
        <div className="headerActions">
          <button className="homeBtn" onClick={() => setTab('shell')}><svg className="es-home-svg" viewBox="0 0 24 24" aria-hidden="true"><path d="M3.5 11.2 12 4l8.5 7.2"/><path d="M5.8 10.2V20h4.6v-5.4h3.2V20h4.6v-9.8"/></svg><span className="homeText">Home</span></button>
        </div>
      </header>

      <div className="tabs">
        <button className={tab === 'shell' ? 'active' : ''} onClick={() => setTab('shell')}>🏠 Trang chủ</button>
      ...
      {tab === 'shell' && (
        <main className="shellGrid">
          <section className="panel appTile disabled">
            <div className="appIcon">✍️</div>
            <h2>Easy Script</h2>
            <p>Viết và tối ưu script podcast.</p>
            <span>Coming soon</span>
          </section>
          <section className="panel appTile disabled">
            <div className="appIcon">🎙️</div>
            <h2>Easy Voice/Video</h2>
            <p>Tạo voice, subtitle và video.</p>
            <span>Coming soon</span>
          </section>
          <section className="panel appTile activeTile" onClick={() => setTab('home')}>
            <div className="appIcon">🖼️</div>
            <h2>Easy Thumbnail</h2>
            <p>Tạo prompt, phân tích style, ghép thumbnail.</p>
            <span>Mở app</span>
          </section>
        </main>
      )}
      ...
      {tab === 'home' && (
        <main className="homeGrid">
          <section className="panel homeCard" onClick={() => setTab('tao-prompt')}><div className="homeIcon">✨</div><h2>Tạo Prompt</h2><p>Tạo prompt sạch cho Flow từ chủ đề hoặc script.</p></section>
          <section className="panel homeCard" onClick={() => setTab('phan-tich')}><div className="homeIcon">🔍</div><h2>Phân tích ảnh/video</h2><p>Upload thumbnail/video mẫu để phân tích style và tạo prompt.</p></section>
          <section className="panel homeCard" onClick={() => setTab('composer')}><div className="homeIcon">🖼️</div><h2>Ghép Thumbnail</h2><p>Import ảnh từ Flow, thêm chữ, viền, bóng và xuất PNG.</p></section>
          <section className="panel homeCard" onClick={() => setTab('settings')}><div className="homeIcon">👥</div><h2>Profile nhân vật</h2><p>Tạo nhiều profile nhân vật/thương hiệu và chọn khi tạo prompt.</p></section>
        </main>
      )}

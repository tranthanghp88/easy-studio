...
safeHandle('script:generate-step', async (_event, payload) => {
  try {
...
safeHandle('script:export-text', async (_event, payload) => {
...
safeHandle('script:import-text', async () => {
...
safeHandle('script:save-project', async (_event, payload) => {
...
safeHandle('script:load-project', async () => {
...
safeHandle('settings:save', async (_event, payload) => {
  try {
...
safeHandle('settings:test-provider', async (_event, payload) => {
  try {
...
module.exports = { registerEasyScriptHandlers: () => true };
